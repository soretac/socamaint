...
class ClientMiddleware(TenantMainMiddleware):
    """
    ...
    def get_tenant(self, domain_model, hostname):
        client = super().get_tenant(domain_model, hostname)
        if client.ese_activate == False:
            raise self.TENANT_NOT_FOUND_EXCEPTION("Ce site est inactif")
        return client
